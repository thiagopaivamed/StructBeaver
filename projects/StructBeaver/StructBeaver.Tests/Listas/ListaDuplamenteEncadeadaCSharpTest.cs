...
public class ListaDuplamenteEncadeadaCSharpTests
{
    private readonly ListaDuplamenteEncadeadaCSharp _listaDuplamenteEncadeadaCSharp;

    public ListaDuplamenteEncadeadaCSharpTests()
        => _listaDuplamenteEncadeadaCSharp = new ListaDuplamenteEncadeadaCSharp();
